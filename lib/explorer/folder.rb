  ...
  class Folder
    ...
    def show(html, count=nil)
      ...
      for file in @fileList
        ...
        img = "<a href=\"javascript:;\" onclick=\"window.open('http://tomoyo.uraz.org/cgi-bin/explorer/bin/player.cgi?src=/flv/" + flv[0].to_s + "', 'winName', 'left=0,top=0,width=670,height=572,status=0,scrollbars=0,menubar=0,location=0,toolbar=0,resizable=0');\"><img src=\"" + @const.PLAY_ICON + "\" align=\"absmiddle\" border=0></a> "
        html += img * flv.size
